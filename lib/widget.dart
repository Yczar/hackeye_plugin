...
import 'package:hackeye_plugin/widget_callback_dispatcher.dart';

/// A Flutter Plugin to simplify setting up and communicating with HomeScreenWidgets
class HaeyeWidget {
  static const MethodChannel _channel = MethodChannel('hackeye_widget');
  static const EventChannel _eventChannel = EventChannel('hackeye_widget/updates');
